...
(function ($) {
    class $my_smz extends $.$mol_book2 {
        ...
        Source() {
            ...
            obj.uri = () => "https://github.com/nin-jin/smz-hack";
            return obj;
        }
        Lights() {
        ...
        Menu() {
            const obj = new this.$.$mol_page();
            obj.title = () => this.$.$mol_locale.text('$my_smz_Menu_title');
            obj.tools = () => [
                this.Source(),
                this.Lights()
            ];
    ...
    __decorate([
        $.$mol_mem_key
    ], $my_smz.prototype, "Work_link", null);
    __decorate([
        $.$mol_mem_key
    ], $my_smz.prototype, "Details", null);
    __decorate([
        $.$mol_mem
    ], $my_smz.prototype, "work_store", null);
    __decorate([
        $.$mol_mem
    ], $my_smz.prototype, "person_store", null);
    __decorate([
        $.$mol_mem
    ], $my_smz.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $my_smz.prototype, "Source", null);
    __decorate([
        $.$mol_mem
    ], $my_smz.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
